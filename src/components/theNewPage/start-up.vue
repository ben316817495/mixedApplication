...
<template>
    <div class="startUp">
            ...
            <div class="logoBottom_btnLine">
                <div class="logoBottom_btnLeft">
                     <a class="weui-btn weui-btn_logincolor" @click="gotoUrl('/readyMian/loginPage')" href="javascript:">登陆</a>    
                </div>
            ...
            <div class="bottomFontStyle">
                Copyright © 2017 xinyi-移动产品部.前端团队
            </div>
    </div>
</template>
